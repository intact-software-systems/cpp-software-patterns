...
------------------------------------------------------------------------- */
void
DLDistanceNetworkHeuristic::Algorithm(vertex_descriptorN zsource)
{
...
/* -------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------*/
void
DLDistanceNetworkHeuristic::ConstructDNHTree(GraphN &dnh_graph, const ShortestPathKeeper &dnh_mst)
{
...
/* -------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------*/
void
DLDistanceNetworkHeuristic::ConstructSPGraph(const GraphN &dn_graph, GraphN &temp_sp_graph, const ShortestPathKeeper &dng_spk)
{
...
/* -------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------*/
void
DLDistanceNetworkHeuristic::ConstructDNHeuristicGraph(GraphN &dnh_graph, GraphN &temp_sp_graph)
{
...
/* -------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------*/
void
DLDistanceNetworkHeuristic::ConstructDNGraph(GraphN &dn_graph, vertex_descriptorN gz_source, vertex_descriptorN &dngz_source)
{
...
/* -------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------*/
void
DLDistanceNetworkHeuristic::FindMST(GraphN &input_graph, vertex_descriptorN zsource, ShortestPathKeeper &spk)
{
	...
	myDBPrimMST(input_graph, zsource, zdistance, zparent, inputT.V);
...
/*
void
DLDistanceNetworkHeuristic::DNHTest(GraphN &dn_graph)
{
